export const TEXT_SIZE_H1 = "24px";
export const TEXT_SIZE_H2 = "22px";
export const TEXT_SIZE_H3 = "20px";
export const TEXT_SIZE_H4 = "18px";
export const TEXT_SIZE_H5 = "16px";
export const TEXT_SIZE_H6 = "12px";
export const TEXT_SIZE_P = "14px";
...
export const TWITTER_DM =
  "https://twitter.com/messages/compose?recipient_id=388806300";
